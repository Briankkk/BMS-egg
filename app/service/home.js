...
class HomeService extends Service {
    async login(userName,password) {
        ...
        const staff = await client_global.query('select a.STAFF_ID as STAFF_ID, a.STAFF_NAME as STAFF_NAME,a.STAFF_CODE as STAFF_CODE,a.STAFF_ROLE as STAFF_ROLE,a.CUST_ID as CUST_ID,b.CUST_CODE as CUST_CODE from staff a join cust b on a.cust_id=b.cust_id where a.staff_code=? and a.password=? and a.state=?',[userName,password,'A']);
